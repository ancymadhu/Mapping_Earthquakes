...
// Layor 1: Create the earthquake layer for our map.
let earthquakes = new L.layerGroup();

// Layor 2: Create the tectonic layer for our map.
let major_earthquakes = new L.layerGroup();


// Layor 3: Create the tectonic layer for our map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
 ...
 // 4. Retrieve the tectonic GeoJSON data.
